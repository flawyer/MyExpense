...
async function getData(): Promise<ExpenseForm[]> {
  try {
    const response = await axios.get('https://expenseincomeapi.onrender.com/api/ExpenseForm');
...
export default function DemoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      await axios.post('https://expenseincomeapi.onrender.com/api/ExpenseForm', { name: formData });
